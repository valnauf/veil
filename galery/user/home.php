...
<div class="container-fluid mt-3">
  ...
  <div class="row">
    ...
    <img src="../img/Fantasy-World-With-Dragons.jpg" class="rounded" height="200" width="300">
    ...
    <div class="col-sm-3 p-6 text-dark">
    <img src="../img/Flying-Fantasy-World.jpg" class="rounded" height="200" width="300">
    <h5 class="card-title">Jane Doe</h5>
  ...
  <div class="row">
    <div class="col-sm-3 p-6 text-dark">
    <img src="../img/view-1.jpg" class="rounded" height="200" width="300">
    <h5 class="card-title">Jane Doe</h5>
    <a href="#user" class="btn btn-white"><img class="rounded-circle" height="30" width="30" src="https://api.duniagames.co.id/api/content/upload/file/14273970761629438505.jpg">     naufal</a>
    </div>
    <div class="col-sm-3 p-6 text-dark">
